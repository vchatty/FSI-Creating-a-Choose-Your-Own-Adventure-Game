...
if (firstAnswer === "left") {
    let secondAnswer = window.prompt('You come across a stray cat. It scampers off down a small hole, just lage enough for you to crawl through. Do you follow it, or continue on your path?')
    ...
    if (secondAnswer === "follow") {
        ...
        if (thirdAnswer === "ladder") {
            ...
            let fourthAnswer = window.prompt("After ascending the staircase, you discover a shiny blue stone, which you take home and cherish forever. One day it starts to glow. Do you crack it open?")


            if (fourthAnswer === "yes") {
             let fifthAnswer = window.prompt("Congratulations! You've acquired the power of time travel!")
            }
        }
    }
}
    ...
    let secondAnswer = window.prompt ('You come across a snoring dragon. On the other side of him you see a shiny treasure chest. Another path would lead you away from the dragon altogether. Which path do you take? Past the dragon or away from the dragon?')
    ...
    if (secondAnswer === "past the dragon") {
        let thirdAnswer = window.prompt ("The dragon wakes up and sits upright. You only have a moment to respond, to stay or run:")
         ...
         let fifthAnswer = window.prompt("Quickly, you run back to the cave's entrance. Sheepish, you return home.")
        }
    }
